...
static cmd_ret_t cmd_tb_reset_ctr(cmd_group_t*);
static cmd_ret_t cmd_tb_dump_ctr(cmd_group_t*);
static cmd_ret_t cmd_tb_type_filter(cmd_group_t*);
static cmd_ret_t cmd_tb_dump(cmd_group_t*);
static cmd_ret_t cmd_tb_dump_def(cmd_group_t*);
static cmd_ret_t cmd_tb_cpu(cmd_group_t*);
static cmd_ret_t cmd_tb_events(cmd_group_t*);
static cmd_ret_t cmd_tb_evt(cmd_group_t*);
static cmd_ret_t cmd_tb_tcb(cmd_group_t*);
static cmd_ret_t cmd_tb_showfilters(cmd_group_t*);
static cmd_ret_t cmd_tb_zero(cmd_group_t*);
